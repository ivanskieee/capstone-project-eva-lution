...
<div class="col-lg-12 mt-5">
    <div class="card">
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" id="new_secondary_faculty">
                <input type="hidden" name="secondary_id" value="<?php echo isset($faculty['secondary_id']) ? $faculty['secondary_id'] : ''; ?>">
                <div class="row">
                ...
                <div class="col-lg-12 text-right justify-content-center d-flex">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="window.location.href = './secondary_faculty_list.php';">Cancel</button>
                </div>
            </form>
        </div>
    </div>
