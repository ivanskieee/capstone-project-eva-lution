    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" id="new_head_faculty">
                <input type="hidden" name="head_id" value="<?php echo isset($faculty['head_id']) ? $faculty['head_id'] : ''; ?>">
                <div class="row">
                ...
                <div class="col-lg-12 text-right justify-content-center d-flex">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="window.location.href = './head_faculty_list.php';">Cancel</button>
                </div>
            </form>
        </div>
    </div>
