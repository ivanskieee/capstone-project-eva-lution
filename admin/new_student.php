            ...
            <div class="card-body">
                <form method="POST" id="new_student" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 border-right">
                            <div class="form-group">
                                ...
                                <input type="text" id="school_id" name="school_id" class="form-control form-control-sm"
                                    required
                                    value="<?php echo isset($student['school_id']) ? $student['school_id'] : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="" class="control-label">First Name</label>
                                <input type="text" id="firstname" name="firstname" class="form-control form-control-sm"
                                    required
                                    value="<?php echo isset($student['firstname']) ? $student['firstname'] : ''; ?>">
                            </div>
                            <div class="form-group">
                                <label for="" class="control-label">Last Name</label>
                                <input type="text" id="lastname" name="lastname" class="form-control form-control-sm"
                                    required
                                    value="<?php echo isset($student['lastname']) ? $student['lastname'] : ''; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group d-flex justify-content-center align-items-center">
                                <img src="<?php echo isset($student['avatar']) ? 'uploads/' . $student['avatar'] : ''; ?>"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control form-control-sm" name="email" id="email"
                                    required value="<?php echo isset($student['email']) ? $student['email'] : ''; ?>">
                                <small id="msg"></small>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Password</label>
                                <input type="password" class="form-control form-control-sm" name="password"
                                    id="password" <?php echo isset($student) ? '' : 'required'; ?>>
                    ...
                    <div class="col-lg-12 text-right justify-content-center d-flex">
                        <button type="submit"
                            class="btn btn-success btn-secondary-blue mr-3"><?php echo isset($student) ? 'Update' : 'Submit'; ?></button>
                        <button type="button" class="btn btn-secondary"
                            onclick="window.location.href = './student_list.php';">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
