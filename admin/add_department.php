...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['department_code']) && isset($_POST['department_name'])) {
    $department_code = strtolower(trim($_POST['department_code'])); 
    $department_name = ucwords(strtolower(trim($_POST['department_name']))); 
    $department_name = preg_replace('/\bOf\b/', 'of', $department_name); 
