...
<head>
    ...
    <link rel="stylesheet" href="path/to/font-awesome/css/all.min.css"> <!-- Adjust path as needed -->
    <style>
        .sidebar-hidden {
            display: none;
        }
...
<body>
    <div id="wrapper">
        <aside id="sidebar" style="background-color: rgb(51, 128, 64);" class="main-sidebar sidebar-dark-primary elevation-4 sidebar-hidden">
            <div class="dropdown">
