...
$query = $conn->prepare("SELECT * FROM college_faculty_list WHERE faculty_id = :faculty_id");
...
<form id="accountForm" enctype="multipart/form-data">
    ...
    <div class="form-group d-flex justify-content-center align-items-center">
        <img src="<?php echo isset($faculty['avatar']) ? 'uploads/' . htmlspecialchars($faculty['avatar']) : ''; ?>"
    ...
    <div class="form-group">
        ...
        <input type="text" name="firstname" class="form-control"
            value="<?php echo htmlspecialchars($faculty['firstname']); ?>" required>
    </div>
    <div class="form-group">
        <label for="lastname">Last Name</label>
        <input type="text" name="lastname" class="form-control"
            value="<?php echo htmlspecialchars($faculty['lastname']); ?>" required>
    </div>
    <div class="form-group">
